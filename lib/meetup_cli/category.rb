class MeetupCli::Category
  ...
  def activities
    ...
    activities_array = [Activiy.new("So cal Happy hour backpacking", "we're 3871 Happy Hour Back Packers"), Activiy.new("Eastside Bike Club", "We're 336 Eastside bike club members!!")]
  end
end
